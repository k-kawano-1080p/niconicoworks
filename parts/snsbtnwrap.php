...
li.btn-comm{font: normal normal normal 14px/1 FontAwesome;padding: 10px 4px 6px 4px;margin:14px;border-radius: 3px;display: flex;flex-direction: column;display: -webkit-flex;-webkit-flex-direction: column;width: 66px;}
